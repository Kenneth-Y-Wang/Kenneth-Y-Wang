...
- :computer: I’m currently working on making redesigned Codazen website & Meta Experience Hub, also creating Meta Developer Center, and updating Meta pay/WhatsApp payment & Meta Connect with the brand new Quest Pro headset! 
- :muscle: I’m strong in - JavaScript(ES5 and ES6), HTML5, CSS3, React, Socket IO, SQL, Node.js, TypeScript, MUI, Etc.
- :mortar_board: I'm experienced with - Gatsby, Next.Js, GraphQL, Google Ads, Google Analysis, AWS connect, AWS EB, C++, Express, AJAX, PHP, SEO, SAP2000, GIS, Etc.
- :wrench: I'm using tools such as - Git, GitHub, Contentful, VS Code, Figma, React Dev Tools, Amazon Web Service, AWS CodeBuild & Pipeline, AutoCAD, MATLAB, Etc.
