...
- :wrench: I'm using tools such as - Git, GitHub, Contentful, Strapi, Elastic Search, dbeaver, VS Code, Figma, React Dev Tools, AWS EB, CodeBuild & Pipeline, AutoCAD, MATLAB, Etc.
